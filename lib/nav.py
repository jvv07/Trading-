...
.vc-nav{position:fixed;top:0;left:0;right:0;height:52px;background:#1a1d27;border-bottom:1px solid #252a38;display:flex;align-items:center;padding:0 24px;z-index:99999;font-family:'Space Grotesk',-apple-system,sans-serif;box-sizing:border-box;gap:0;}
.vc-logo{font-size:15px;font-weight:700;color:#f0f4f8;letter-spacing:-0.01em;white-space:nowrap;text-decoration:none !important;margin-right:32px;flex-shrink:0;}
...
.vc-a:hover{color:#f0f4f8;text-decoration:none !important;}
.vc-a.vc-on{color:#f0f4f8;border-bottom-color:#4ade80;}
...
.vc-dd:hover .vc-dd-btn{color:#f0f4f8;}
.vc-dd-menu{display:none;position:absolute;top:52px;left:0;background:#1a1d27;border:1px solid #252a38;border-radius:8px;padding:6px;min-width:160px;box-shadow:0 8px 24px rgba(0,0,0,0.5);z-index:100000;}
...
.vc-dd-menu a:hover{color:#f0f4f8;background:rgba(74,222,128,0.08);}
.vc-search{display:flex;align-items:center;background:#12151e;border:1px solid #252a38;border-radius:8px;overflow:hidden;height:34px;margin-left:auto;flex-shrink:0;}
.vc-search input{background:transparent;border:none;color:#f0f4f8;font-size:14px;padding:0 12px;width:160px;outline:none;font-family:'Space Grotesk',sans-serif;}
.vc-search input::placeholder{color:#8892a4;}
.vc-search input:focus{outline:none;}
.vc-search button{background:#4ade80;border:none;color:#061409;font-size:13px;font-weight:600;padding:0 14px;height:100%;cursor:pointer;transition:opacity 0.15s;font-family:'Space Grotesk',sans-serif;}
